...
- **[Intro to MiCBuS](https://shanshan-zhang.github.io/MiCBuS/vignettes/Intro_to_MiCBuS.html)**

You can also access it locally after installing MiCBuS:


```r
vignette("Intro_to_MiCBuS")



For an example how to use MiCBuS
Example datasets are given in the Package
